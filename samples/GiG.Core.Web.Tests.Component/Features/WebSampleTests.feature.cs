...
namespace GiG.Core.Web.Tests.Component.Features
{
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Get the balance")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void GetTheBalance()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get the balance", null, new string[] {
                        "mytag"});
#line 4
