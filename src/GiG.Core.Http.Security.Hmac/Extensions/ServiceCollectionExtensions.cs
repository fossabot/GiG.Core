...
namespace GiG.Core.Http.Security.Hmac.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddClientHmacAuthentication([NotNull]this IServiceCollection services)
        {
            services.TryAddSingleton<HmacDelegatingHandler>();
        ...
        /// <returns>The <see cref="IServiceCollection" />.</returns>
        public static IServiceCollection ConfigureDefaultHmacDelegatingHandlerOptionProvider([NotNull]this IServiceCollection services, [NotNull]IConfigurationSection configurationSection)
        {
            if (services == null) throw new ArgumentNullException(nameof(services));
            if (configurationSection == null) throw new ArgumentNullException(nameof(configurationSection));

            services.TryAddTransient<IHmacOptionsProvider, DefaultHmacOptionsProvider>();
