...
namespace GiG.Core.Orleans.Streams.Abstractions
{
    ...
    public interface IStreamFactory
    {
        ...
        /// </summary>
        /// <param name="streamProvider">The <see cref="global::Orleans.Streams.IStreamProvider"/> from which to create the stream.</param>
        ...
        IStream<TMessage> GetStream<TMessage>(global::Orleans.Streams.IStreamProvider streamProvider, Guid streamId, string streamNameSpace);
    }
}