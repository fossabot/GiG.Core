...
namespace GiG.Core.Orleans.Streams.Abstractions
{
    ...
    public interface IStreamFactory
    {
        ...
        /// </summary>
        /// <param name="streamProvider">The <see cref="IStreamProvider"/> from which to create te stream.</param>
        ...
        IStream<TMessage> GetStream<TMessage>(IStreamProvider streamProvider, Guid streamId, string streamNameSpace) where TMessage : IMessage;
    }
}