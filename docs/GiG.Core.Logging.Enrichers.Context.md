...
This Library provides an API to register the Context Enricher for Logging when using Serilog.
When using this Library your application will enrich logs with the IP Address of the originating request if available.
